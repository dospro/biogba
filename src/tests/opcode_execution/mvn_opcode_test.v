...
/*
The MVN opcode is a Dataprocessing Opcode
which is already tested. The opcode works the same way as MOV
with the difference that tha value moved is negated (all bits fliped)
*/


/*
Test MVN opcode loads a value into a register
...
fn test_mvn() {
	...
	assert result.r[3] == 0x0FFF_FFF0
}

/*
Test MVN opcode when Rd=15 and S=true
...
fn test_mvn_r15_s_edge_case() {
	...
	assert result.r[15] == 0x0FFF_FFF0
}
