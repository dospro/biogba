...
/*
The RSC opcode is a Dataprocessing Opcode which is already tested.
*/

/*
Test RSC (reverse substract) opcode performs Rd = operand - Rn + c - 1
...
fn test_rsc() {
	...
	cpu_state.r[13] = 0 // rd
	cpu_state.r[14] = 0x0000_EE00 // rn
	cpu_state.cpsr.c = false //  Make sure it is off

	mut cpu := ARM7TDMI{}
	cpu.set_state(cpu_state)
	opcode := biogba.RSCOpcode{
		rd:            13
		rn:            14
